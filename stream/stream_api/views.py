...
class StreamAPIView(CreateAPIView):
    ...
    def create(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            collection_of_streambytes=self.mainfunc(query,color)
    ...
    def mainfunc(self,query,color):
        ...
        def post_process(input_image, outputs,j):
            ...
            for i in indices:
                ...
                if classes[class_ids[i]]=="bed" or classes[class_ids[i]]=="chair" or classes[class_ids[i]]=="couch" :
                    # print("bed hae")
                    ...
                    selected=check_color(croped,str(color))
                    cv2.imwrite("images_outout.jpg",croped)
                    if selected :
        ...
        for i,j in zip(glob.glob("input/*.jpg"),list_of_url):
